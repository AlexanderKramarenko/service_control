...
values ('Стиральные машины', 'category_washing_machine_edit2.jpg', 'Ремонт стиральных машин всех типов',
        '#!/order_request',
        'ремонт стиральных машин', 150, 150),
       ('Холодильники', 'category_refrigerator_edit2.jpg', 'Качественный ремонт холодильников', '#!/order_request',
        'ремонт холодильников', 150, 150),
       ('Пылесосы', 'category_vacuum_cleaner_edit2.jpg', 'Используем только оригинальные запчасти', '#!/order_request',
        'ремонт пылесосов', 150, 150),
       ('Смартфоны', 'category_smartphone_edit2.jpg', 'Ремонтируем смартфоны любых марок', '#!/order_request',
        'ремонт смартфонов', 150, 150),
       ('Телевизоры', 'category_tv_edit2.jpg', 'Ремонт телевизоров любой сложности', '#!/order_request',
        'ремонт телевизоров',
        150, 150);
